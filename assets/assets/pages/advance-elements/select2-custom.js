...
$(document).ready(function(){
    ...
    $('.searchable').multiSelect({
        selectableHeader: "<input type='text' class='form-control' autocomplete='off' placeholder='Specifications'>",
        selectionHeader: "<input type='text' class='form-control' autocomplete='off' placeholder='Specifications'>",
        ...
        selectableHeader: "<input type='text' class='form-control' autocomplete='off' placeholder='Filters'>",
        selectionHeader: "<input type='text' class='form-control' autocomplete='off' placeholder='Filters'>",
        afterInit: function(ms) {
            var that = this,
                $selectableSearch = that.$selectableUl.prev(),
                $selectionSearch = that.$selectionUl.prev(),
