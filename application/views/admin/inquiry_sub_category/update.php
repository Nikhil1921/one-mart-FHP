...
<div class="card">
	<div class="card-block">
		...
		<form action="<?= base_url('admin/inquirySubCategory/update/').$cat['id'] ?>" method="POST" enctype="multipart/form-data" id="subcatForm">
			<div class="row">
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="sub_cat" id="sub_cat" placeholder="Sub Category Name" value="<?= (!empty(set_value('sub_cat'))) ? set_value('sub_cat') : $cat['sub_cat']  ?>">
							<?=  form_error('sub_cat') ?>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
						<div class="col-sm-4">
							<label class="col-form-label" for="image">Sub Category Image</label>
						</div>
						<div class="col-sm-8">
