	...
	<div class="card-block">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" value="<?= $cat['conditions'] ?>" disabled>
					</div>
				</div>
			</div>
		</div>
		<div class="form-group row">
			<div class="col-sm-2 offset-3">
				<a href="<?= base_url('admin/services'); ?>" class="btn btn-info btn-round waves-effect waves-light fa fa-check"></a>
			</div>
			<div class="col-sm-2 offset-3">
