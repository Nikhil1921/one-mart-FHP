...
<div class="card">
	<div class="card-block">
		<div class="row card-block">
			...
			<div class="col-12 row">
				...
				<div class="col-2" align="right">
					<a href="<?= base_url('admin/forMembership/add'); ?>" class="btn btn-success btn-round waves-effect waves-light fa fa-plus"></a>
				</div>
				<div class="col-2" align="right">
		...
		<input type="hidden" id="url" value="<?= base_url('admin/forMembership/get')?>">
	</div>
</div>