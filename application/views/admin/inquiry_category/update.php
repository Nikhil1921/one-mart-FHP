...
<div class="card">
	<div class="card-block">
		...
		<form action="<?= base_url('admin/inquiryCategory/update/').$cat['id'] ?>" method="POST" enctype="multipart/form-data" id="catForm">
			<div class="row">
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="cat_price" id="cat_price" placeholder="Category Price" value="<?= (!empty(set_value('cat_price'))) ? set_value('cat_price') : $cat['cat_price'] ?>">
