...
<div class="card">
	<div class="card-block">
		...
		<form action="<?= base_url('admin/'.$name.'/sliderUpload/'.$id) ?>" class="dropzone">
			<div class="fallback">
		...
		<div class="row">
			...
			<div class="col-md-4 mb-4" id="<?= $k ?>_remove">
				<img src="<?= base_url('assets/images/category/'.$img) ?>" alt="" class="col-md-8">
		...
		<input type="hidden" id="slider-url" value="<?= base_url('admin/'.$name.'/removeSlider') ?>">
	</div>
</div>