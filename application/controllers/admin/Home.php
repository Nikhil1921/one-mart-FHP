	...
	public function get()
    {
        if (access($this->name,'index')) {
            ...
            {  
                ...
                $sub_array[] = '
                <a href="'.base_url('admin/home/view-order/').$row->id.'" class="btn waves-effect waves-dark btn-success btn-outline-success btn-icon fa fa-eye"></a>';  
        	...
        	$output = array(
                ...
                "recordsTotal"      =>     $this->main->count($this->table, ['is_delete'=>'no', 'status'=>$this->input->post('status')]),
